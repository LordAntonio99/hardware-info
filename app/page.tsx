...
const MainPage = () => {
  ...
  return (
    <div className="grid grid-cols-2 gap-8 p-8">
      {loading.state ? <h1>Loading</h1> : <h1>Loaded</h1>}
          ...
          <Table>
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>{systemInformation.CPU_DATA?.stepping}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Revision</TableCell>
                <TableCell>{systemInformation.CPU_DATA?.revision}</TableCell>
              </TableRow>
              <TableRow>
              ...
              <TableRow>
                ...
                <TableCell>
                  {systemInformation.CPU_DATA?.virtualization ? "Yes" : "No"}
                </TableCell>
              </TableRow>
            </TableBody>
          </Table>
        ...
        <CardContent>
          <Table>
            <TableBody>
              ...
              <TableRow>
                <TableCell>Version</TableCell>
                <TableCell>{systemInformation.BIOS_DATA?.version}</TableCell>
              </TableRow>
              <TableRow>
              ...
              <TableRow>
                <TableCell>Revision</TableCell>
                <TableCell>{systemInformation.BIOS_DATA?.revision}</TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </CardContent>
